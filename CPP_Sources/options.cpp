...
{ 
    ...
    m_resolutions_settings.push_back(Resolution_settings(Resolution(1600, 1200),   2, 36, 36,  9,  9, 304, -256));
    m_resolutions_settings.push_back(Resolution_settings(Resolution(1920, 1080), -13, 90, 70, 15, 15, 304, -720));
    m_resolutions_settings.push_back(Resolution_settings(Resolution(1920, 1200),   2, 36, 36,  9,  9, 304, -256));
    m_resolutions_settings.push_back(Resolution_settings(Resolution(2048, 1080),   2, 36, 36,  9,  9, 304, -256));
    m_resolutions_settings.push_back(Resolution_settings(Resolution(3840, 2160),   2, 36, 36,  9,  9, 304, -256));
